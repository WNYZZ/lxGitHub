 ...
 *
 * file: templates/default/js/jquery.min.js
 */
 ...
 *
 * file: templates/default/js/bootstrap.min.js
 */
...
/**
 * include jquery.themepunch.revolution.min.js
 *
 * file: templates/default/js/jquery.themepunch.revolution.min.js
 */
...
/**
 * include jquery.themepunch.plugins.min.js
 *
 * file: templates/default/js/jquery.themepunch.plugins.min.js
 */
 ...
 *
 * file: templates/default/js/jquery.touchSwipe.min.js
 */
 ...
 *
 * file: templates/default/js/jquery.mousewheel.min.js
 */
 ...
 *
 * file: templates/default/js/jquery.prettyPhoto.ks
 */
...
/**
 * include jquery.carouFredSel-6.2.1-packed.js
 *
 * file: templates/default/js/jquery.carouFredSel-6.2.1-packed.js
 */
 ...
 * include script.js
 *
 * file: templates/default/js/script.js
 */

(function($){
    $(document).ready(function(){jQuery("ul.nav li.dropdown").hover(function(){jQuery(this).find(".dropdown-menu").stop(true,true).delay(200).fadeIn();},function(){jQuery(this).find(".dropdown-menu").stop(true,true).delay(200).fadeOut();});$("[rel=tooltip]").tooltip();$("[data-rel=tooltip]").tooltip();$(".carousel").carousel({interval:false});$(".hover_img, .hover_colour").on("mouseover",function(){var info=$(this).find("img");info.stop().animate({opacity:.1},500);});$(".hover_img, .hover_colour").on("mouseout",function(){var info=$(this).find("img");info.stop().animate({opacity:1},800);});$(window).scroll(function(){if($(this).scrollTop()>200){$(".go-top").fadeIn(200);}else{$(".go-top").fadeOut(200);}});$(".go-top").click(function(event){event.preventDefault();$("html, body").animate({scrollTop:0},300);});});$("iframe").each(function(){var ifr_source=$(this).attr("src");var wmode="wmode=transparent";if(ifr_source.indexOf("?")!=-1){var getQString=ifr_source.split("?");var oldString=getQString[1];var newString=getQString[0];$(this).attr("src",newString+"?"+wmode+"&"+oldString);}else $(this).attr("src",ifr_source+"?"+wmode);});$(function(){$(".welcome").show().addClass("animated fadeInDown");$(".welcome_index").show().addClass("animated fadeInDown");$(".intro_sections h6").show().addClass("animated fadeInUp");$(".fadeinup").show().addClass("animated fadeInUp");$(".fadeindown").show().addClass("animated fadeInDown");});$("a[data-rel]").each(function(){$(this).attr("rel",$(this).attr("data-rel")).removeAttr("data-rel");});$("a[rel^='prettyPhoto']").prettyPhoto();jQuery("a[rel^='prettyPhoto'], a[rel^='lightbox']").prettyPhoto({overlay_gallery:false,social_tools:false,deeplinking:false});
})(jQuery);
