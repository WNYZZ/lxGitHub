	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		<tr>
			...
			<td width="350"><select name="infotype" id="infotype">
				<?php
				foreach(array('0'=>'单页','1'=>'列表','2'=>'产品','3'=>'下载','4'=>'商品') as $k => $v)
				{
					if($row['infotype'] == $k)
		...
		<tr>
			<td height="35" align="right">栏目名称(中文)：</td>
			<td><input name="classname" type="text" id="classname" value="<?php echo $row['classname']; ?>"  class="class_input" />
				<span class="maroon">*</span></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td height="35" align="right">栏目名称(英文)：</td>
			<td><input name="en_classname" type="text" id="en_classname" value="<?php echo $row['en_classname']; ?>"  class="class_input" />
				<span class="maroon">*</span></td>
			<td>&nbsp;</td>
		</tr>
