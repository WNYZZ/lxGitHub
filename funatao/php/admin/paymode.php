...
<form name="form" id="form" method="post" action="paymode_save.php?action=save">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table">
		...
		<tr align="center" class="mgr_tr">
			...
			<td class="action"><span>[<a href="paymode_save.php?id=<?php echo $row['id']; ?>&action=check&checkinfo=<?php echo $row['checkinfo']; ?>" title="点击进行显示与隐藏操作"><?php echo $checkinfo; ?></a>]</span><span>[<?php echo $delstr; ?>]</span></td>
		</tr>
		<?php
			}
		}
