	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr>
			...
			<td><input name="picurl" type="text" id="picurl" class="class_input" />
				<span class="maroon">&nbsp;</span><span class="cnote"><span class="gray_btn" onclick="GetUploadify('uploadify','缩略图上传','image','image',1,<?php echo $cfg_max_file_size; ?>,'picurl')">上 传</span></span></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
