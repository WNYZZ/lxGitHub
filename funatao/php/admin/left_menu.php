	...
	<div class="viewport">
		<div class="overview">
			...
			<div class="menubox" style="display:none">
				<div class="title"  onclick="DisplayMenu('leftmenu01');" title="点击切换显示或隐藏"> 网站系统管理 </div>
				<div id="leftmenu01" style="display:none"> <a href="admin.php" target="main">管理员管理</a> <a href="site.php" target="main">站点配置管理</a> <a href="web_config.php" target="main">网站信息配置</a> <a href="upload_filemgr_sql.php" target="main">上传文件管理</a><a href="database_backup.php" target="main">数据库管理</a> <a href="admingroup.php" target="main" title="管理组管理" class="admingroup"></a> </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
				<div class="title ton" id="t1" onclick="DisplayMenu('leftmenu02');" title="点击切换显示或隐藏"> 栏目内容管理 </div>
				<a href="infoclass.php" target="main">栏目管理</a>
				<div id="leftmenu02" >
                <a href="infoclass.php" target="main"  style="display:none">栏目管理</a>
                <a href="maintype.php"  target="main"  style="display:none">二级类别管理</a>
					<div class="hr_1"> </div>
					<a href="infolist.php" target="main">列表信息管理</a>
					<a href="info.php" target="main">单页信息管理</a>
                    <a href="infoimg.php" target="main">产品信息管理</a>
                    <a href="modeldata.php?m=pic" target="main">图文信息管理</a>
					<a href="modeldata.php?m=video" target="main">视频中心管理</a>
                    <a style="display:none" href="soft.php" target="main">软件下载管理</a>
					<div class="hr_1"> </div>
					<a  style="display:none" href="fragment.php" target="main">碎片数据管理</a>
                    <a href="diymenu.php"  style="display:none" target="main">自定义菜单项</a>
                    <a href="diymodel.php"  style="display:none" target="main">自定义模型</a>
                    <a href="diyfield.php"  style="display:none" target="main">自定义字段</a>
                    <a href="infoflag.php"  style="display:none" target="main" title="信息标记管理" class="infoattr"></a> <a href="infosrc.php" target="main" title="信息来源管理" class="infosrc"></a> </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox" style="display:none;">
...
<div class="hr_5"></div>
<div class="copyright" style="display:none;"> © 2014 <a href="http://phpMyWind.com/" target="_blank">phpMyWind.com</a><br />
