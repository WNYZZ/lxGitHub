...
?>
<div class="gray_header"> <span class="title">修改产品信息</span> <span class="reload"><a href="javascript:location.reload();">刷新</a></span> </div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
		...
		<tr class="nb"  >
			...
			<td><fieldset class="picarr">
					...
					if($row['picarr'] != '')
					{
						...
						{
							$v = explode(',', $v);
							echo '<li rel="'.$v[0].'"><img class=zuhetu src=/'.$v[0].'><input type="text" name="picarr[]" value="'.$v[0].'"><a href="javascript:void(0);" onclick="ClearPicArr(\''.$v[0].'\')">删除</a><br /><input type="text" name="picarr_txt[]" value="'.$v[1].'"><span>描述</span></li>';
						}
					}
					?>
					</ul>
        ...
        <style>.zuhetu { width:100px; height:100px; }</style>
		<tr class="nb">
			<td colspan="2" height="26"><div class="line"> </div></td>
		</tr>
		<tr>
